        ...
        if (!Utils.isInitDb(context)) {
            new Thread(new Runnable() {
                ...
                public void run() {
                     ...
                     * FROM DRAWABLE
                     */
                    ArrayList<EmoticonBean> emojiArray2 = ParseData(DefEmoticons.emoticonArray, EmoticonBean.FACE_TYPE_NOMAL, ImageBase.Scheme.DRAWABLE);
                    EmoticonSetBean emojiEmoticonSetBean2 = new EmoticonSetBean("emoji", 3, 7);
                    emojiEmoticonSetBean2.setIconUri("drawable://f000");
                    emojiEmoticonSetBean2.setItemPadding(DisplayUtils.dp2px(context, 20));
...
//                    emojiEmoticonSetBean.setItemPadding(DisplayUtils.dp2px(context, 20));
...
//                    xhsEmoticonSetBean.setItemPadding(DisplayUtils.dp2px(context, 20));
...
//                    bean.setItemPadding(DisplayUtils.dp2px(context, 20));
